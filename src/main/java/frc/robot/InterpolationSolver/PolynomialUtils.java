 ...
 *  @author Kevin Wayne
 */
public class PolynomialUtils implements Comparable<PolynomialUtils> {
  ...
  /**
     ...
     */
    public PolynomialUtils(double[] x, double[] y, int degree) {
        this(x, y, degree, "n");
    }
  ...
  /**
     ...
     * @throws IllegalArgumentException if the lengths of the two arrays are not equal
     */
    public PolynomialUtils(double[] x, double[] y, int degree, String variableName) {
        this.degree = degree;
   ...
   /**
     ...
     */
    public int compareTo(PolynomialUtils that) {
        double EPSILON = 1E-5;
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        PolynomialUtils regression = new PolynomialUtils(x, y, 3);
